...
int main(int argc, char *argv[]){
  ...
  istate = atoi(argv[1]);
  //if (argc != 5){
  //  cerr << "Usage: Ndots,istate, Nsamps, dot size in nm (8.0, 8.5, 12.6)" << endl;
  //  cerr << argc << endl;
  //  exit(1); 
  //}
...
void read_input(){
  ...
  ifstream infile("start.inpt");
  if(!infile){
    cerr << "ERROR: coult not find file start.inpt" << endl;
    exit(1);
  }
  ...
  //cout << "p Ndots " << Ndots << endl;
  //cout << "p istate " << istate << endl;
  //cout << "p Nsamp " << Nsamp << endl;
  //cout << "p size " << size << endl;
  //cout << "p size_x " << SL[0] << endl;
  //cout << "p size_y " << SL[1] << endl;
  //cout << "p hop_time " << hop_time << endl;
  //cout << "p tcutoff " << tcutoff << endl;
  //cout << "p Temp " << Temp << endl;
